        ...
        if (window.matchMedia(`(min-width : ${width})`).matches) {
            ...
            for (let i = 0; i < 95; i+=increment) {
                for (let j = 0; j < 100; j+=20) {
                    lottieHtml += 
                    `
                    <lottie-player src="mystify/assets/animations/background-animation.json" background="transparent" speed="0.1" mode="bounce" loop autoplay style="top: ${i}%; left: ${j}%"></lottie-player>
                    `;
